...
\usepackage[absolute,overlay]{textpos}%для хитрых текстов поверх всего
\usepackage{amsfonts}
\usepackage{amsmath}
\usepackage{wrapfig}
\usepackage{physics} 
...
\usepackage[russian,english]{babel}  % last is the main language
\usepackage{mmap}  % to copy Russian letters https://texfaq.org/FAQ-cpy-srchpdf 
%--------------------------------------
...
\renewcommand{\vb}[1]{\text{\bf #1}} %костыль, а то жирные формулы не работают что-то
...
\begin{tikzpicture}[remember picture,overlay]
	\node[anchor=north east,yshift=2pt] at (current page.north east) {\includegraphics[height=0.7cm]{fig/logo_faculty_only}};  
\end{tikzpicture}}
